...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{mass_conservation}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{capacity_constraints}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{density_constraints}
